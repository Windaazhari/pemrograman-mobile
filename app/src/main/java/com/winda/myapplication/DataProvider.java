package com.winda.myapplication;

import android.content.Context;

import com.winda.myapplication.R;
import com.winda.myapplication.model.anjing;
import com.winda.myapplication.model.ayam;
import com.winda.myapplication.model.hewan;
import com.winda.myapplication.model.kucing;
...
public class DataProvider {
    ...
    private static List<ayam> iniDataAyam(Context ctx) {
        List<ayam> ayams = new ArrayList<>();
        ayams.add(new ayam("Rubah Merah", "Britania Raya dan Irlandia",
                "Rubah merah dikenalkan di Australia pada abad ke-15, bulu rubah ini bewarna merah kecoklatan", R.drawable.ayam_acona));
        ayams.add(new ayam("Fennec", "Afrika Utara",
                "rubah ini dikenal sebagai jenis mamalia paling kecil di dunia dan termasuk hewan nokturnal", R.drawable.ayam_brahma));
        ayams.add(new ayam("Rubah Kelabu", "Amerika Utara",
                "rubah kelabu adalah sebuah spesies mamalia omnivora dari keluarga Canidae, bulu rubah ini berwarna abu-abu", R.drawable.ayam_kapas));
        ayams.add(new ayam("Rubah Kit", "Amerika Utara",
                "Rubah ini disebut juga Rubah Fennec Amerika yang telinganya besar besar", R.drawable.ayam_lechorn));
        ayams.add(new ayam("Rubah korsak", "Britania Raya dan Irlandia",
                "Rubah korsak adalah rubah berukuran sedang yang bisa ditemukan di Stepa, semi-gurun dan gurun di Asia Tenggara,tersebar dari Mongolia dan Timur Laut Cina.", R.drawable.ayam_wilk));
